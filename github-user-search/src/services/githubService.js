...
const buildAdvancedQuery = ({ keyword, location, minRepos }) => {
    // Start query with the main keyword (e.g., username/topic)
    let query = keyword || "";
...
// ----------------------
// 3. Advanced Search + Detailed User Fetch
// ----------------------
/**
...
export const searchUsers = async (criteria, page = 1, perPage = 10) => {
    try {
        ...
        // 2. FETCH FULL PROFILE DETAILS for each user (REQUIRED for detailed info like 'location' and 'public_repos')
